...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Hero — WIGRO Reifen Witten"
    >
      {/* Hintergrundbild */}
      ...
      {/* Content */}
      <div className="relative z-10 container-content text-center px-4 py-20 md:py-28">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          {/* Trust Badge — styled like the original top badge */}
