...
// CSS Transitions statt Framer Motion für maximale Performance auf Handys
...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  return (
    <>
      {/* Overlay / Backdrop — immer im DOM, opacity gesteuert */}
      <div
        className={cn(
          'fixed inset-0 z-overlay bg-black/60 transition-opacity duration-200',
      ...
      {/* Slide-Over Panel — immer im DOM, translate-x gesteuert */}
      <div
        className={cn(
          'fixed top-0 right-0 h-full z-modal bg-brand-bg shadow-float',
          'flex flex-col transform-gpu transition-transform duration-200 ease-spring',
